...
// CONCATENATED MODULE: ./src/modules/tasksModule.tsx
...
const tasksModule = Object(toolkit_["createSlice"])({
  name: "tasks",
  initialState,
  reducers: {
...
/* harmony default export */ var modules_tasksModule = (tasksModule);
...
const rootReducer = Object(toolkit_["combineReducers"])({
  tasks: modules_tasksModule.reducer,

        ...
        <section className={classes.root}>
            <Container className={classes.container}>
                ...
                <Typography
                    ...
                    component="h2"
                >
                    How it works　どうやって使うか
                </Typography>
                <div>
                    <Grid container spacing={5}>
                        <Grid item xs={12} md={4}>
                            <div className={classes.item}>
                                <div className={classes.number}>1.パターンを作る</div>
                                <img
                        ...
                        <Grid item xs={12} md={4}>
                            <div className={classes.item}>
                                <div className={classes.number}>2.カレンダーに設定</div>
                                <img
                        ...
                        <Grid item xs={12} md={4}>
                            <div className={classes.item}>
                                <div className={classes.number}>3.決めたタイミングで実行</div>
                                <img
                                    src="/static/time.svg"
                                    alt="time"
                                    className={classes.image}
